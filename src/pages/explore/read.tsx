...
type ReadPageProps = Record<string, any> & SiteData;

const findMostSimilarBlock = (
  input: string,
  blocks: TextBlock[]
): TextBlock => {
  return blocks.reduce(
    (acc, b) => {
      const score = getSimilarityScore(input, String(b.text));
            ...
            content={
              <div className="px-1 py-2 text-gray-500">
                ...
                <div className={"text-gray-500 mt-2"}>
                  <span>From: {mostSimilarBlock.document[0].title}</span>
                  <br />
                  <div>
                    <Link
