...
export const VideoIcon = (props: IconSvgProps) => (
    ...
    >
        ...
        <path
            d="M8 12.4956V10.6167C8 8.28736 9.56765 7.33031 11.4822 8.49848L13.0231 9.44145L14.5641 10.3844C16.4786 11.5526 16.4786 13.4597 14.5641 14.6278L13.0231 15.5708L11.4822 16.5138C9.56765 17.6608 8 16.7108 8 14.3745V12.4956Z"
...
export const PauseIcon = ({size = 24, width, height, ...props}: IconSvgProps) => (
    <svg
        ...
        {...props}
    >
        <path d="M9 16L9 8" stroke="#292D32" strokeWidth="2.5" strokeMiterlimit="10" strokeLinecap="round"
              strokeLinejoin="round"/>
        <path d="M15 16L15 12L15 8" stroke="#292D32" strokeWidth="2.5" strokeMiterlimit="10" strokeLinecap="round"
              strokeLinejoin="round"/>
    </svg>
);
...
export const TreeIcon = ({size = 24, width, height, ...props}: IconSvgProps) => (
    ...
    >
        <path
            d="M16.17 10.06H7.83001C6.65001 10.06 6.24001 9.27001 6.93001 8.31001L11.1 2.47001C11.59 1.77001 12.41 1.77001 12.9 2.47001L17.07 8.31001C17.76 9.27001 17.35 10.06 16.17 10.06Z"
            fill={props.fill || "currentColor"}
        />
        <path
            d="M17.59 18H6.41C4.83 18 4.29 16.95 5.22 15.67L9.21 10.06H14.79L18.78 15.67C19.71 16.95 19.17 18 17.59 18Z"
            fill={props.fill || "currentColor"}
        />
...
export const LocationIcon = ({size = 24, width, height, ...props}: IconSvgProps) => (
	<svg viewBox="0 0 395.71 395.71"
         width={size}
         height={size}
		 {...props}
	>
