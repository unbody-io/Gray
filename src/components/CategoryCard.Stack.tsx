...
import {CategoryHeadCard, UseCatHeadAnimationsState} from "@/components/CategoryCard.Header";
...
export const CategoryCardStack = (props: Props) => {
    const {data: {title, summary, articles, blocks}, onOpen, openIndex = -1, index, delay = 1000} = props;
