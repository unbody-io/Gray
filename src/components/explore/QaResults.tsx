...
export const QaResults = (props: QaResultsProps) => {
    const {payload: {data, isLoading, error}} = props;
    ...
    ) ? data!._additional.answer.result : null;
                    ...
                    <blockquote className={"p-6"}>
                        {
                            qaAnswer ?
                                <div className={"flex flex-col gap-4"}>
                                    {
                                        ...
                                        <span className={"text-tiny"}>
                                            From <Link className={"text-gray-500 text-tiny"}
                                    ...
                                    <Divider/>
                                    <blockquote>
                                        <p className={"text-md font-medium leading-relaxed indent-6"}>
                                            "...{qaAnswer}"
                                        </p>
                                    </blockquote>
                                </div>
                                :
                                <div>
                                    <span>It seems that there's not any exact answer match for your question. Probably you can try the</span>
                                    <Link className={"hover:text-white cursor-pointer text-gray-50 underline mr-1 ml-1 text-base"}
