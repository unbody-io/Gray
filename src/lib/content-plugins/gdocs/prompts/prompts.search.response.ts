...
const handler: PromptHandlerFn = {
    create: (siteConfigs, siteData, input) => {
        ...
        intro += `In this case, your job is to generate a response based on provided the metadata of google docs to complete the following task:\n`;
        ...
        switch (input.type) {
            ...
            case "Question":
                prompt += `Answer the following question based on the provided records:\n`;
            ...
            case "Instruction":
                prompt += `Follow this instruction using the provided records:\n`;
